const { getUser, supabase, locationFromRequest } = require('../_admin');
...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    const member = { user_id: String(user.userId), username, avatar: user.avatar || null, ...location, last_seen_at: now, updated_at: now };
